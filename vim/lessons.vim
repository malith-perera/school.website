...
argglobal
%argdel
$argadd /var/www/school.website/public_html/tmpl/theme1/lesson_view_tmpl.php
set stal=2
tabnew
tabrewind
edit /var/www/school.website/public_html/tmpl/theme1/lesson_view_tmpl.php
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 79 - ((8 * winheight(0) + 23) / 47)
...
normal! 020|
tabnext
edit /var/www/school.website/public_html/js/lesson.js
argglobal
balt /var/www/school.website/public_html/tmpl/theme1/lesson_view_tmpl.php
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
tabnext 2
set stal=1
badd +0 /var/www/school.website/public_html/tmpl/theme1/lesson_view_tmpl.php
badd +0 /var/www/school.website/public_html/js/lesson.js
