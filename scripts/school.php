...
// Curriculum tables
function create_curriculum_table($db)
{
    global $servername, $username, $password;
    ...
    if (mysqli_query($conn, $sql)) {
        echo "Table curriculum table created successfully\n";
    }
    else {
        echo "Error: Creating curriculum table: " . mysqli_error($conn) . "\n";
    }
