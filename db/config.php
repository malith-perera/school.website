...
function create_schools_table()
{
    ...
    $sql = "CREATE TABLE IF NOT EXISTS schools (
        school_id   INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, /* shool_id use by the system */
        school_key  VARCHAR(128) NOT NULL,                      /* school_key is given by school staff */
...
function create_subject_grade_table()
{
    global $servername, $username, $password, $db_name;
    ...
    // sql to create table
    $sql = "CREATE TABLE IF NOT EXISTS subject_grade (
